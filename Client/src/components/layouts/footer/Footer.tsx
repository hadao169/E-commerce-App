...
import DropdownMenuCountry from "./DropdownCountries";
...
const Footer = () => {
  return (
    <footer className="w-full responsive-padding-x py-8 bg-white text-gray-500 text-[12px]">
          ...
          <div key={section.title}>
            ...
            {section.socials && (
              <ul className="mt-2 space-y-3">
                {(section.socials as Social[]).map((social, i) => {
      ...
      {/* Below section */}
      <div className="border-t border-gray-300 mt-6 text-sm flex items-center justify-between pt-4 gap-8 w-full">
